...
fallbackToggle.className = 'dysolutions-chat-fallback';
fallbackToggle.setAttribute('aria-label', 'Abrir chatbot DySolutions');
...
if (target && !target.dataset.dysolutionsChatInitialized) {
  target.dataset.dysolutionsChatInitialized = 'true';
